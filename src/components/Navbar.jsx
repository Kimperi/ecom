...
const Navbar = () => {
  ...
  const { user, isAdmin, loading: authLoading } = useSession();
    ...
    <div className="flex justify-between items-center py-5 font-medium bg-white shadow-sm md:px-10 px-5 ">
      ...
      <div className="flex items-center gap-5 flex-1 justify-end">
        <div className="group relative flex items-center gap-2">
          {userName ? (
            <>
              <span className="hidden lg:inline text-sm text-gray-700">Welcome, {userName}</span>
              <button
      ...
      >
        <div className="flex flex-col text-gray-600 h-full">
          <div className="flex items-center justify-between p-4 border-b">
            ...
            <button onClick={() => setVisible(false)} className="p-2 -m-2" aria-label="Close menu">
          ...
          <div className="flex-1 flex flex-col gap-1 p-3">
            ...
            {userName ? (
              ...
              <NavLink className="py-2 pl-6" to="/login" onClick={() => setVisible(false)}>
                LOGIN
              </NavLink>
            )}
          </div>
